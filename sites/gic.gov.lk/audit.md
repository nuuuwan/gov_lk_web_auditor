# Website Audit: https://gic.gov.lk/
...
Published postal address: Subject Select a topic General Inquiry Make a Complaint Technical Issue Feedback Message Send Message GIC Sri Lanka The ; Phone: 1919; Email: info@gic.gov.lk; Published named responsibility: division

| Test | Result | Details |
| --- | --- | --- |
| postal_address | ✅ | Published postal address: Subject Select a topic General Inquiry Make a Complaint Technical Issue Feedback Message Send Message GIC Sri Lanka The  |
| reachable_contacts | ✅ | Phone: 1919; Email: info@gic.gov.lk |
