# Website Audit: https://lrh.health.gov.lk/
...
| Test | Result | Details |
| --- | --- | --- |
| postal_address | ✅ | Published postal address: HHIMS Training Staff Welfare {"prefetch":[{"source":"document","where":{"and":[{"href_matches":"/*"},{"not":{"href_match |
