...
| Test | Result | Details |
| --- | --- | --- |
| postal_address | ✅ | Published postal address: with your appointment staff ahead of time to avoid frustration. For more help with specific addresses see below. The Nat |
