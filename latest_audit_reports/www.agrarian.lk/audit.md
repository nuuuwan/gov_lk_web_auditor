...
| Test | Result | Details |
| --- | --- | --- |
| postal_address | ✅ | Published postal address: Password Remember me Login body { min-height: 100vh; background: linear-gradient(135deg, rgba(246, 249, 242, 0.96), rgba |
