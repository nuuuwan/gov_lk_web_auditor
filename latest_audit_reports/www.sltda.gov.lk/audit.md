# Website Audit: https://www.sltda.gov.lk/
...
Detected generic hosting marker: apache2 ubuntu default page
...
| hosting_configured | ❌ | Detected generic hosting marker: apache2 ubuntu default page |
